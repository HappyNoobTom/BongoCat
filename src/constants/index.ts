...
export const LISTEN_KEY = {
  ...
  OBS_AUDIO_SETTINGS_CHANGED: 'obs-audio-settings-changed',
  OBS_AUDIO_STATE_CHANGED: 'obs-audio-state-changed',
  OBS_AUDIO_STATE_REQUEST: 'obs-audio-state-request',
  OBS_AUDIO_TEST_ACTION: 'obs-audio-test-action',
